...
interface AdminOrderCreatedNotificationEmailProps {
  buyerName?: string
  buyerEmail?: string
  courseName?: string
  amount?: string
...
export default function AdminOrderCreatedNotificationEmail({
  ...
  orderNumber = 'TA-20260110-0007',
  couponCode = null,
  couponDiscount = null,
  adminUrl = 'https://academy.tinta.wine/admin/orders',
}: AdminOrderCreatedNotificationEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>
        Nueva orden creada - {buyerName} - {orderNumber}
      </Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Section style={styles.content}>
            {/* Info Badge */}
            <Section style={styles.infoBadge}>
              <Text style={styles.infoText}>ORDEN CREADA</Text>
            </Section>

            <Heading style={styles.title}>Nueva orden de pago creada</Heading>
            ...
            <Text style={styles.text}>
              ...
              ) inició una orden de <strong>{paymentMethod}</strong> para{' '}
              <strong>{courseName}</strong>.
            </Text>

            <Text style={styles.text}>
              La orden está pendiente de completarse por parte del alumno. No
              requiere acción de tu parte en este momento.
            </Text>

            {/* Amount Box */}
            <Section style={styles.amountBox}>
              <Text style={styles.amountLabel}>Monto de la orden</Text>
            ...
            <Text style={styles.smallText}>
              Te llegará otro email cuando el alumno complete el pago.
            </Text>
          </Section>
...
const styles = {
  ...
  amountBox: {
    backgroundColor: 'rgba(20, 63, 59, 0.75)',
    borderRadius: emailTheme.borderRadius,
    margin: '24px 0',
    padding: '20px',
    textAlign: 'center' as const,
