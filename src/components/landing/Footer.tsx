...
export function Footer({ links, contactInfo, onNavigate, onSubscribe }: FooterProps) {
  ...
  return (
    <footer className="bg-verde-uva-700 text-white">
      {/* Main Footer Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 mb-12 items-stretch">
          ...
          <div>
            ...
            <p className="text-white/80 text-lg leading-relaxed mb-5 max-w-md">
              ...
              Cursos presenciales y online para toda Latinoamérica.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              ...
              >
                <a href={`mailto:${contactInfo.email}`}>
                  <Mail size={20} className="text-verde-uva-300" />
              ...
              >
                ...
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-verde-uva-300">
              ...
              <div className="flex items-center gap-3 text-white/70 p-2 sm:col-span-2">
                <MapPin size={20} className="text-verde-uva-300 shrink-0" />
          ...
          <div className="flex flex-col h-full">
            <div className="bg-white/5 rounded-2xl p-10 h-full flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-verde-uva-300 mb-4">
                Newsletter
              </h3>
              ...
              {subscribed ? (
                <div className="text-verde-uva-300 font-medium text-center py-4">
                ...
                <form onSubmit={handleSubscribe} className="flex gap-3">
                  <Input
                    ...
                    className="flex-1 h-11 bg-white/10 border-white/20 text-white placeholder:text-white/50 focus-visible:border-verde-uva-300 focus-visible:ring-verde-uva-300/20"
                    required
                    disabled={isLoading}
                  />
                  <Button
                    type="submit"
                    className="h-11 px-6 bg-verde-uva-500 text-white hover:bg-verde-uva-400"
                    disabled={isLoading}
                  >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          {/* About Links */}
          <div>
            <h4 className="font-semibold text-verde-uva-300 mb-4">
              Sobre Nosotros
            </h4>
