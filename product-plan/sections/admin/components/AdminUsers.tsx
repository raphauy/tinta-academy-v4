...
import type { AdminUsersProps } from '@/../product/sections/admin/types'
import { AdminMetricCard } from './AdminMetricCard'
import { UserRow } from './UserRow'

type SortField = 'name' | 'email' | 'role' | 'createdAt' | 'lastLogin'
type SortDirection = 'asc' | 'desc'
type RoleFilter = 'all' | 'admin' | 'educator' | 'student' | 'user'
    ...
    <div className="p-4 sm:p-6 pb-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
        <p className="text-sm text-stone-500 dark:text-stone-400">
          ...
          {(searchQuery || roleFilter !== 'all') && users.length !== filteredUsers.length && (
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <SortButton field="createdAt" label="Registro" />
            <SortButton field="lastLogin" label="Último acceso" />
          </div>
        </div>
      </div>
