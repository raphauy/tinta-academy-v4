# Tinta Academy — Design Handoff

This folder contains everything needed to implement Tinta Academy.
...
|---------|-------------|------------|
| Landing & Catálogo | Public landing with hero and course catalog | 6 components |
| Student Panel | Student dashboard, courses, orders, profile | 6 components |
| Educator Panel | Educator dashboard, course editor, students, emails | 15 components |
| Admin | Admin dashboard, users, orders, coupons | 20 components |
...
│   └── incremental/
│       ├── 01-foundation.md
│       ├── 02-landing-and-cat-logo.md
│       ├── 03-student-panel.md
│       ├── 04-educator-panel.md
│       └── 05-admin.md
│
