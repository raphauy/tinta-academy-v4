...
Before using this prompt, fill in the following:

- **SECTION_NAME** = [Human-readable name, e.g., "Landing & Catálogo" or "Student Panel"]
- **SECTION_ID** = [Folder name in sections/, e.g., "landing-and-cat-logo" or "student-panel"]
...
- **@product-plan/sections/SECTION_ID/*.png** — Screenshots for visual reference
...
## Quick Reference: Section IDs and Milestones

| Section | Folder ID | Milestone |
|---------|-----------|-----------|
| Landing & Catálogo | landing-and-cat-logo | 02 |
| Student Panel | student-panel | 03 |
| Educator Panel | educator-panel | 04 |
| Admin | admin | 05 |
